...
const poloPackages = [
  {
    name: "Polo Lacoste Soft",
    price: "79.000",
    description:
      "Pilihan ekonomis untuk kebutuhan seragam perusahaan, event, gathering, komunitas, dan merchandise dalam jumlah besar.",
    features: [
      "Minimal order 100 Pcs",
      "Bahan Lacoste Soft",
      "Bordir Komputer",
    ...
    whatsappText:
      "Halo CITILEX ASIA, saya tertarik dengan Polo Shirt Lacoste Soft (Rp 79.000/pcs). Saya ingin konsultasi mengenai kebutuhan saya.",
    popular: false,
  },

  {
    name: "Polo Lacoste Pique",
    price: "113.000",
    description:
      "Pilihan populer untuk seragam perusahaan dan event dengan bahan Lacoste Pique, rapi, dan cocok digunakan sehari-hari.",
    features: [
      "Minimal order 100 Pcs",
      "Bahan Lacoste Pique",
      "Bordir Komputer",
      "Ukuran Standard Asia (XS - XL)",
      "Jahitan rapi dan finishing premium",
    ],
    whatsappText:
      "Halo CITILEX ASIA, saya tertarik dengan Polo Shirt Lacoste Pique (Rp 113.000/pcs). Saya ingin konsultasi mengenai kebutuhan saya.",
    popular: true,
  },

  {
    name: "Polo Lacoste Diamond",
    price: "119.000",
    description:
      "Kualitas premium untuk kebutuhan corporate dan merchandise eksklusif dengan bahan yang nyaman, tampilan elegan, dan finishing lebih detail.",
    features: [
      "Minimal order 100 Pcs",
      "Bahan Lacoste Diamond Premium",
      "Bordir Komputer",
      "Ukuran Standard Asia (XS - XL)",
      "Finishing premium dan jahitan lebih detail",
    ],
    whatsappText:
      "Halo CITILEX ASIA, saya tertarik dengan Polo Shirt Lacoste Diamond Premium (Rp 119.000/pcs). Saya ingin konsultasi mengenai kebutuhan saya.",
    popular: false,
  },
];
                  ...
                  <div className="relative space-y-7">
                    ...
                    <div className={priceBorderClass}>
                      ...
                      <div className="flex items-end justify-center gap-1">
                        ...
                        <span className={priceNumClass}>
                          {pkg.price}
                        </span>
        
                        <span className="text-sm mb-1.5 text-white/45">
                          /pcs
                        </span>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-5 grid grid-cols-1 gap-6 md:gap-7">
              <div className="group relative overflow-hidden bg-white border border-brand-platinum min-h-[296px] hover:-translate-y-1 hover:shadow-xl transition-all duration-500">
                <div className="relative w-full h-full min-h-[296px] overflow-hidden">
                  <Image src="/galeri6.png" alt="CITILEX ASIA Computer Embroidered Polo Shirt" fill className="object-cover transition-transform duration-700 group-hover:scale-105" referrerPolicy="no-referrer" />
